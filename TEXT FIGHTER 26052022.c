...
if (diceQ == 2)
printf("     You subdued the opponent at a fast pace!\n");
if (diceQ == 3)
printf("     You settled the combat with efficiency!\n");
if (diceQ == 4)
printf("     You outfought the opponent effectively!\n");
...
printf("\n");
printf("     You won in %d rounds with the Alpha Magic Combo!\n", ctr);
if ((ctr > 8) && (cpusp < 2) && (new6 > 0))
printf("\n");
if (new6 > 0)
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("\n     Could anyone have doubted the final outcome?\n");
if (diceQ == 2)
