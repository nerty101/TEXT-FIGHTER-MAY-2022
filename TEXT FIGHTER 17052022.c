...
printf("\n     You activate the ALPHA MAGIC SUPER ATTACK!\n");
printf("     CPU HP at %d\n", enemyhp);
++magsp;
++spmag2;
++spmag2;
...
printf("\n");
printf("     You won in %d rounds with the Alpha Magic Attack!\n", ctr);
if ((ctr > 8) && (cpusp < 2) && (new6 > 0))
printf("\n");
if (new6 > 0)
...
printf("\n     You perform the MAGIC POWER ATTACK!\n");
printf("     CPU HP at %d\n", enemyhp);
magsp3 = 0;
magsp2 = 0;
spctrbon = spctrbon2;
...
printf("     You won in %d rounds with Power Magic!\n", ctr);
